    ...
    public partial class FixWishlistPropertyRelationship : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertyAmenity", x => new { x.AmenityId, x.PropertyId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Email", "FullName", "Password", "PhoneNumber", "ProfilePictureUrl", "Role" },
                values: new object[] { 1, "admin@airbnb.com", "Admin User", "admin123", "1234567890", "https://th.bing.com/th/id/OIP.g5nSTvKkjrlJL-nvP1LxEwHaHa?w=600&h=600&rs=1&pid=ImgDetMain", 2 });
